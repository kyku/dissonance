...
/// Provides an interface for creating encrypted Noise streams. This is the main
/// entry point of this crate.
pub mod noise_session;

/// Provides codecs for encoding byte streams into a sequence of Noise messages
pub mod noise_codec;

/// Provides a codec for multiplexing different sender and receiver messages
/// over a single connection
pub mod asymmetric_codec;

/// Provides a socket interface over an encrypted stream of Noise messages
